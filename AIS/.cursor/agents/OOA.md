...
1. Architectural Drivers 작성 (`docs/Architectural_Drivers.md`)
   - Primary Functionality (Use-Case Model 포함), QAS, Constraints를 포함하는 하나의 통합 산출물로 작성한다.
   - **Primary Functionality**:
     ...
     . System이 외부에 제공하는 인터페이스를 식별하기 위해 Use case별 상세 설명 및 system sequence diagram (SSD)을 작성한다.
