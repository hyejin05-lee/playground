---
name: Architecture_Design_Diagram
model: inherit
...
입력:
- `docs/CDA_Evaluation_and_Design_Decision.md` (최종 Architecture Design Decision 및 Domain Model)
- `docs/Architectural_Drivers.md` (Use Case Model, System Sequence Diagram(SSD), QAS)
- `docs/Domain_Model.md` (Domain Model Diagram)
